...
class Grammar:
    ...
    def values(self):
        ...
        self.ebnf.string = (
            "single_quoted, double_quoted, " "double_quoted_heredoc"
        )

        list = self.ebnf.collection(
            "osb", "base_expression", "base_expression", "csb"
        )
        self.ebnf.set_rule("!list", list)
        self.ebnf.key_value = (
            "(string, path, number, boolean) " "colon base_expression"
        )
        ...
        values = (
            "number, string, boolean, null, (list|map) value_fragment*, "
    ...
    def assignments(self):
        ...
        path_fragment = "dot name, osb " "(expression | range) csb"
        self.ebnf.path_fragment = path_fragment
        self.ebnf.path = (
            "name (path_fragment)* | " "inline_expression (path_fragment)*"
        )
        self.ebnf.operator_assignment = (
            "ADD_EQUALS, SUB_EQUALS, DIV_EQUALS, " "MUL_EQUALS, MOD_EQUALS"
        )
        ...
        self.ebnf.assignment = (
            "(path | assignment_destructoring) " "assignment_fragment"
        )
    ...
    def expressions(self):
        ...
        self.ebnf.cmp_operator = (
            "GREATER, GREATER_EQUAL, LESSER, " "LESSER_EQUAL, NOT_EQUAL, EQUAL"
        )
        ...
        self.ebnf.dot_expression = (
            f"primary_expression dot_arguments*, "
            f"float_mut arguments* cp dot_arguments*"
        )
        self.ebnf.pow_expression = (
            "dot_expression (pow_operator "
            "unary_expression)?, dot_expression"
        )
        self.ebnf.unary_expression = (
            "unary_operator unary_expression , " "pow_expression"
        )
        self.ebnf.to_expression = "unary_expression (to_operator)?"
        self.ebnf.mul_expression = (
            "(mul_expression mul_operator)? " "to_expression"
        )
        self.ebnf.arith_expression = (
            "(arith_expression arith_operator)? " "mul_expression"
        )
        self.ebnf.cmp_expression = (
            "(cmp_expression cmp_operator)? " "arith_expression"
        )
        self.ebnf.and_operator = "AND"
        self.ebnf.and_expression = (
            "(and_expression and_operator)? " "cmp_expression"
        )
        self.ebnf.or_operator = "OR"
        self.ebnf.or_expression = (
    ...
    def service_block(self):
        ...
        self.ebnf.when_service_fragment = (
            "(command arguments*|arguments+) " "output?"
        )
    ...
    def call_expression(self):
        self.ebnf.call_expression = (
            "path op arguments* " "(nl indent (arguments nl?)* dedent)? cp"
        )
    ...
    def function_block(self):
        ...
        function_statement = (
            "function_type name typed_argument* " "function_output?"
        )
    ...
    def try_block(self):
        ...
        try_block = (
            "try_statement nl nested_block catch_block? " "finally_block?"
        )
    ...
    def block(self):
        ...
        block = (
            "rules nl, if_block, foreach_block, function_block, "
