...
@mark.parametrize(
    ...
    [
        ...
        ("f=a[ : b]", "f = a[:b]"),
        ("a= null", "a = null"),
        ("my_service call arg1 :1 arg2: 2", "my_service call arg1:1 arg2:2"),
        (
...
"""
    story_format(
        """function my_fun foo:int returns string
    x = 0
"""
    ) == result
...
"""
    story_format(
        """function my_fun returns string
    x = 0
"""
    ) == result
